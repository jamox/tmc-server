class SubmissionPackager
  ...
  private
    ...
    def copy_files(exercise, received, dest)
      ...
      FileUtils.cp_r(cloned  + 'checking', dest + 'checking')
    ...
    def copy_libs(cloned, dest)
      FileUtils.cp(tmc_xml_grader_path, dest + 'tmc-xml-grader.rb')
    end
    ...
    def tmc_xml_grader_path
      "#{::Rails.root}/lib/testrunner/tmc-xml-grader.rb"
    end
  end
end
